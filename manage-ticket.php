            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="country" class="form-control" required>
                        <option value="USA" <?php if ($edit_ticket['country'] == "USA") echo "selected"; ?>>USA</option>
                        <option value="UK" <?php if ($edit_ticket['country'] == "UK") echo "selected"; ?>>UK</option>
                        <option value="India" <?php if ($edit_ticket['country'] == "India") echo "selected"; ?>>India</option>
                    </select>
                </div>
